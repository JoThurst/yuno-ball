...
def fetch_and_store_player_stats(player_id):
    ...
    for attempt in range(retries):
        try:
        ...
        except playercareerstats.exceptions.TimeoutError as e:
            # Handle timeout errors
            print(f"Timeout fetching stats for player {player_id}: {e}")
            ...
            # Handle unexpected errors but only log and stop retries
