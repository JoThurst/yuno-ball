...
class LeagueDashPlayerStats:
    ...
    def get_all_stats(cls, filters=None):
        ...
        base_query = """
            ...
            min_rank, fgm_rank, fg_pct_rank, fg3m_rank, fg3a_rank, 
            fg3_pct_rank, ftm_rank, fta_rank, oreb_rank, dreb_rank, reb_rank, ast_rank, tov_rank, stl_rank, blk_rank,blka_rank, pts_rank, pf_rank, pfd_rank, plus_minus_rank, nba_fantasy_points_rank, dd2_rank, td3_rank
