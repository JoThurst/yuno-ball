    ...
    for attempt in range(retries):
        try:
            ...
            if attempt < retries - 1:  # Only retry if attempts are left
                ...
                print(
                    f"Failed to fetch stats for player {player_id} after {retries} attempts.")
...
def fetch_and_store_current_rosters():
    ...
    for team in teams_list:
        ...
        team_roster_data = commonteamroster.CommonTeamRoster(team_id=team_id,
                                                             timeout=600).get_normalized_dict()
