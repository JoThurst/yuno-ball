"""
This module defines the main Blueprint for the Flask application and includes
routes for displaying player information, detailed player statistics, and
...
Dependencies:
- Flask modules: Blueprint, render_template, redirect, url_for, jsonify, request
