...
class LeagueDashPlayerStats:
    ...
    - Ranking Columns (e.g., `gp_rank`, `w_rank`, etc.): Ranking data for corresponding statistics.
    ...
    - Retrieving all stats with filters:
        stats = LeagueDashPlayerStats.get_all_stats(filters={"season": "2023-24", "team_id": 5})
    """
